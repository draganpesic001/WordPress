...
function get_queue_line() {
	...
	$queue_message = "menos de una hora";

	if ( 60 < $queue_minutes )
		$queue_message = "sobre una hora";

	if ( 120 < $queue_minutes )
		$queue_message = "sobre dos horas";

	if ( 180 < $queue_minutes )
		$queue_message = "sobre tres horas";

	if ( 240 < $queue_minutes )
		$queue_message = "sobre cuatro horas";

	if ( 300 < $queue_minutes )
		$queue_message = "sobre cindo horas";

	if ( 360 < $queue_minutes )
		$queue_message = "sobre seis horas";
	
	$queue_line = sprintf( "El tiempo en cue es %s",
			$queue_message );
	return $queue_line;
}
