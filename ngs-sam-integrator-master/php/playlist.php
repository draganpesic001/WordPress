...
echo "Del $first_song al $last_song de $song_count total de temas<br />";
include dirname( __FILE__ ).'/search.php';
echo $queue_line;
?>
		<table border="0" width="98%" cellspacing="0" cellpadding="4">
			<thead>
				<th colspan="3" nowrap align="left">Listado Completo:</th>
			</thead>
<?php
...
//echo '<pre>';print_r($samdb); echo ','; print_r($start_at); echo ','; print_r($number_to_show); echo ','; print_r($playlist_search_text); echo '</pre>';
if ( $playlist ) {
...
<?php 
	echo $queue_line;
	include dirname( __FILE__ ).'/search.php'; 
	echo "Este es $first_song a $last_song de $song_count total de temas<br />";
?>
	</div>
</div>